/**
@file	 MmiTx.cpp
@brief   Multi-Mode Interface TX PTT hardware controller using GPIO
...
This program is distributed in hthe hope that it will be useful,
...
bool MmiTx::initialize(Async::Config &cfg, const std::string name)
{
...
bool MmiTx::setTxOn(bool tx_on)
{
  cerr << "### MmiTx::setTxOn(" << (tx_on ? "true" : "false") << ")\n";
