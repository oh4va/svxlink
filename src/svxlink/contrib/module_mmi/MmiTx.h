...
#ifndef MMI_TX_INCLUDED
#define MMI_TX_INCLUDED
...
@date   2020-07-26
*/
class MmiTx : public Ptt
{
  public:
    struct Factory : public PttFactory<MmiTx>
    {
      Factory(void) : PttFactory<MmiTx>("GPIO") {}
    };
  ...
  private:
    ...
    MmiTx(const MmiTx&);
    MmiTx& operator=(const MmiTx&);
    
};  /* class MmiTx */


#endif /* MMI_TX_INCLUDED */
